...
public class PersonaService {
	...
	@Transactional
	public List<Persona> studentiPerNomeAndCognomeAndDataDiNascita(String nome, String cognome,Date dataDiNascita) {
		return personaRepository.findByNomeAndCognomeAndDataDiNascita(nome, cognome,dataDiNascita);
	}
